...
\item Merge request to add your team to \texttt{TeamComposition.csv}
  \begin{todolist}
  \item Two JSON files are added and the problem description file
  \item Your GitHub repo has been created using the capTemplate template
  \item Github.io pages enabled at Settings/Pages/Source - select GitHub Actions
  \item The course instructor (smiths) has been added as a collaborator to your repo
  \item You have NOT entered the team number
  \item You have NOT entered the TA information
  \item You have entered Custom Documents for Fall and Winter
  \item You have only entered a CD for a User Manual if that is appropriate for your project
  \item Your team name is NOT a generic name like capstoneTeam
  \end{todolist}
\end{itemize}
