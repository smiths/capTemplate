...
The following checklist is relevant when finishing a project in the SE capstone course.

\begin{itemize}
  
\item Clean-up repo
  \begin{todolist}
  \item Issues are closed (with appropriate explanation and/or changes to the repo contents)
