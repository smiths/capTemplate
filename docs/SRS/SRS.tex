...
\begin{figure}[H] % Figure environment for caption and placement
    \centering % Center the image
    \includegraphics[width=0.8\linewidth]{systemcontext.png} % Include the image with desired width
    \caption{Business Data Model} % Add a caption
    \label{fig:systemcontext} % Add a label for referencing in the text
\end{figure}
